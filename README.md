...
`docs/` 底下有兩份可以用瀏覽器直接打開的說明：

- **[`專案介紹.html`](docs/專案介紹.html)** — 這是什麼、為什麼做、能做到什麼、有沒有費用。想先了解再決定要不要裝的人看這份。
- **[`安裝指南.html`](docs/安裝指南.html)** — 八個步驟，每一步都附上「怎麼知道成功了」，還有一段可以直接貼給 AI 助理代勞的提示詞。
